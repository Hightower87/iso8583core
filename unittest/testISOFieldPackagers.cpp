...
TEST_F(testISOFieldPackagers, FIX_n) {
	...
	boost::shared_ptr<ISOField> field = boost::shared_ptr<ISOField>(new ISOField(3, "3915213"));
...
TEST_F(testISOFieldPackagers, FIX_an) {
	...
	boost::shared_ptr<ISOField> field = boost::shared_ptr<ISOField>(new ISOField(3, "915213"));
...
TEST_F(testISOFieldPackagers, FIX_b) {
	...
	boost::shared_ptr<ISOField> field = boost::shared_ptr<ISOField>(new ISOField(3, "3F15213"));
...
TEST_F(testISOFieldPackagers, BCDLL_n) {
	...
	boost::shared_ptr<ISOField> field = boost::shared_ptr<ISOField>(new ISOField(3, "3F15213000000000000"));
...
TEST_F(testISOFieldPackagers, BCDLL_cn) {
	...
	boost::shared_ptr<ISOField> field = boost::shared_ptr<ISOField>(new ISOField(3, "13F1521300000000000"));
...
TEST_F(testISOFieldPackagers, BCDLL_an) {
	...
	boost::shared_ptr<ISOField> field = boost::shared_ptr<ISOField>(new ISOField(3, std::string("\x13\xF1\x52\x13\x00\x00\x00\x00\x00\x00", 10)));
